...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-summit-ui-canvas-detail.ps1

lua tests/test_domain_review.lua

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-summit-ui-canvas-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-summit-ui-canvas-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-summit_ui_canvas_trail-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
