"""Regression checks for the summit-ui-canvas-trail casebook."""
...
from casebook.harness import assert_expected, summit_ui_canvas_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(summit_ui_canvas_trail_summary(), assert_expected())
